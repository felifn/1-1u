...
const tshirtProducts = [
  {
    ...
    price: "$38.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Torn+Mesh+Tee+Black",
  },
  {
    id: 2,
    name: "DECAY TEE (BONE)",
    price: "$35.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Decay+Tee+Bone",
  },
  {
    id: 3,
    name: "RUIN GRAPHIC TEE (CHARCOAL)",
    price: "$42.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Ruin+Graphic+Tee",
  },
  {
    id: 4,
    name: "SHREDDED TEE (GREY)",
    price: "$40.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Shredded+Tee+Grey",
  },
]
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-wider mb-2">TSHIRTS</h1>
          <p className="text-zinc-400">Essential destruction</p>
        </div>
