...
const bottomsProducts = [
  {
    ...
    price: "$48.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Wreck+Cargo+Black",
  },
  {
    id: 2,
    name: "WRECK CARGO SHORTS (OLIVE)",
    price: "$48.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Wreck+Cargo+Olive",
  },
  {
    id: 3,
    name: "DESTROYED JEANS (INDIGO)",
    price: "$98.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Destroyed+Jeans+Indigo",
  },
  {
    id: 4,
    name: "RUIN SWEATPANTS (CHARCOAL)",
    price: "$65.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Ruin+Sweatpants",
  },
]
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-wider mb-2">BOTTOMS</h1>
          <p className="text-zinc-400">Foundation of ruin</p>
        </div>
