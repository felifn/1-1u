...
const newReleases = [
  {
    ...
    price: "$62.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=New+Decay+Henley",
  },
  {
    id: 2,
    name: "WRECK CARGO SHORTS (OLIVE)",
    price: "$48.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=New+Cargo+Olive",
  },
  {
    id: 3,
    name: "TORN MESH TEE (BLACK)",
    price: "$38.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=New+Mesh+Tee",
  },
  {
    id: 4,
    name: "RUIN HOODIE (CHARCOAL)",
    price: "$78.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=New+Ruin+Hoodie",
  },
]
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-wider mb-2">NEW RELEASES</h1>
          <p className="text-zinc-400">Fresh drops from the ruins</p>
        </div>
