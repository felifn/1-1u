...
const blanksProducts = [
  {
    ...
    price: "$28.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Blank+Tee+White",
  },
  {
    id: 2,
    name: "BLANK TEE (BLACK)",
    price: "$28.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Blank+Tee+Black",
  },
  {
    id: 3,
    name: "BLANK HOODIE (GREY)",
    price: "$58.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Blank+Hoodie+Grey",
  },
  {
    id: 4,
    name: "BLANK SWEATPANTS (BLACK)",
    price: "$45.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Blank+Sweatpants",
  },
]
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-wider mb-2">BLANKS</h1>
          <p className="text-zinc-400">Pure essentials</p>
        </div>
