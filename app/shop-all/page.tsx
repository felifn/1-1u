  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-wider mb-2">SHOP ALL</h1>
          <p className="text-zinc-400">Browse our complete collection</p>
        </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="relative">
              <Link href={`/product/${product.id}`}>
                <Card className="bg-zinc-900 border-zinc-800 group cursor-pointer hover:bg-zinc-800 transition-colors">
