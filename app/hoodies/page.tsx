...
const hoodieProducts = [
  {
    id: 1,
    name: "RUIN HOODIE (CHARCOAL)",
    price: "$78.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Ruin+Hoodie+Charcoal",
  },
  {
    id: 2,
    name: "SHREDDED HOODIE (BLACK)",
    price: "$85.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Shredded+Hoodie+Black",
  },
  {
    id: 3,
    name: "DECAY HOODIE (BONE)",
    price: "$82.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Decay+Hoodie+Bone",
  },
  {
    id: 4,
    name: "TORN HOODIE (GREY)",
    price: "$75.00 USD",
    image: "/placeholder.svg?height=400&width=400&text=Torn+Hoodie+Grey",
  },
]
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-wider mb-2">HOODIES</h1>
          <p className="text-zinc-400">Comfort in the chaos</p>
        </div>
